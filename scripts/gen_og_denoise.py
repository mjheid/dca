...
sim_raw = sc.read('/home/kaies/csb/dca/data/twogroupsimulation/twogroupsimulation_witDropout.csv',
...
dca_zinb = dca('/home/kaies/csb/dca/data/twogroupsimulation/twogroupsimulation_witDropout.csv',
                 ...
                 adata2='/home/kaies/csb/dca/data/twogroupsimulation/twogroupsimulation_withoutDropout.csv')
...
sim_raw = sc.read('/home/kaies/csb/dca/data/sixgroupsimulation/sixgroupsimulation_witDropout.csv',
             first_column_names=True).transpose()
sim_raw.obs['Group'] = anno['Group'].values
sc.pp.filter_genes(sim_raw, min_counts=1)
...
dca_zinb = dca('/home/kaies/csb/dca/data/sixgroupsimulation/sixgroupsimulation_witDropout.csv',
                 ...
                 adata2='/home/kaies/csb/dca/data/sixgroupsimulation/sixgroupsimulation_withoutDropout.csv')
dca_zinb.obs['Group'] = anno['Group'].values
